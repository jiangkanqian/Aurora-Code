...
export function Onboarding({
  ...
  const themeStep = <Box marginX={1} flexDirection="column" gap={1}>
      <Text>Let&apos;s get started.</Text>
      <Text bold={true}>Choose the text style that looks best with your terminal</Text>
      <Text dimColor={true}>To change this later, run /theme</Text>
      <Select options={themeOptions} visibleOptionCount={themeOptions.length} defaultValue={theme} defaultFocusValue={theme} onFocus={value => setTheme(value as ThemeSetting)} onChange={value => handleThemeSelection(value as ThemeSetting)} onCancel={() => handleThemeSelection(theme)} />
      <Text dimColor={true}>Preview details will appear after setup, and you can switch anytime with /theme.</Text>
    </Box>;
  ...
  const shouldShowWelcome = currentStep?.id !== 'theme';
  return <Box flexDirection="column">
      {shouldShowWelcome && <WelcomeV2 />}
